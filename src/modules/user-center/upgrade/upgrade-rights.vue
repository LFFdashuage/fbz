...
<template>
	<div class="upgrade scroll-fix" v-if="user.level" v-cloak>
		...
		<template v-if="user.level == 'common'">
			...
			<div class="btns">	
				<x-button type="primary" @click.native="goPage('binding')">会员注册</x-button>
			</div>
		</template>
		...
		<div v-if="user.level == 'dreamPartner'" class="upgrade-content">
			<div class="upgrade-header">
				<img class="upgrade-header-bg" src="~assets/img/upgrade/upgrade.jpg" alt="">
				<div class="upgrade-header-img">
					<img src="~assets/img/upgrade/upgrade-3.jpg" alt="">						
				</div>
			</div>

			<div class="upgrade-person">
				<img src="~assets/img/upgrade/upgrade-icon-3.png" alt="">
				<p>{{ user.levelName }}</p>
			</div>
