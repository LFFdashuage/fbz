...
const routes = [{
    ...
    },
    {
        ...
        component: loadView(loaded => {
            require(['../modules/index/curriculum-order.vue'], loaded)
        }),
        meta: {
            uuid: '',
            title: '富班长'
    ...
    },
    {
        ...
        name: 'specialColumn',
        component: loadView(loaded => {
            require(['../modules/special-column/special-column.vue'], loaded)
        }),
        meta: {
            uuid: '',
            title: '专栏',
        ...
        // 运营管理
        path: '/special-column-operate',
        name: 'specialColumnOperate',
        component: loadView(loaded => {
            require(['../modules/special-column/special-column-operate.vue'], loaded)
        }),
        query: {
            termType: '', // 
            termTypeText: ''
        ...
        component: loadView(loaded => {
            require(['../modules/special-column/special-column-detail.vue'], loaded)
        }),
        meta: {
            uuid: '',
            title: '专栏详情',
        ...
        name: 'xueba',
        component: loadView(loaded => {
            require(['../modules/user-center/xueba/xueba.vue'], loaded)
        }),
        meta: {
            uuid: '',
            title: '学霸卡'
        ...
        name: 'collection',
        component: loadView(loaded => {
            require(['../modules/user-center/collection/collection.vue'], loaded)
        }),
        meta: {
            uuid: '',
            title: '我的收藏'
        ...
        // },
        component: loadView(loaded => {
            require(['../modules/mall/search.vue'], loaded)
        }),
        meta: {
            uuid: '',
            title: '商城搜索'
        ...
        component: loadView(loaded => {
            require(['../modules/mall/goods-order.vue'], loaded)
        }),
        meta: {
            uuid: '',
            title: '商品订单'
        ...
        // 套餐订单
        path: '/order-list-package',
        name: 'orderPackageList',
        component: loadView(loaded => {
            require(['../modules/order/order-package.vue'], loaded)
        }),
        meta: {
            uuid: '',
            title: '套餐订单列表'
        ...
        component: loadView(loaded => {
            require(['../modules/comment/comment.vue'], loaded)
        }),
        meta: {
            uuid: '',
            title: '评论列表'
        ...
        component: loadView(loaded => {
            require(['../modules/comment/comment-type.vue'], loaded)
        }),
        meta: {
            uuid: '',
            title: '评论列表'
